...
I will learn the role of Gradle in building Android Apps and how to use Gradle to manage apps of increasing complexity. I'll learn to:
...
This is the starting point for the final project, which is provided to me in the [course repository](https://github.com/udacity/ud867/tree/master/FinalProject).
...
I may need to download the Google Repository from the Extras section of the
Android SDK Manager.

When I can build an deploy this starter code to an emulator, I'm ready to
move on.
...
Make the button display a toast showing a joke retrieved from my Java joke
telling library.
...
To receive "exceeds specifications", my app must fully implement all of the following items.
